...
- Clean-room verification: `PUBLIC PR #7 OPEN: recovery reprojects the complete canonical v1.2.0 SKILL semantics and reference contracts while keeping MIT licensing, release state, and lineage as distribution metadata. Exact-final-HEAD public validation, both required automated reviews, Bot Comment Closure Rate, merge, merged-tree verification, clean-room invocation, and a new v1.2.0 package remain pending.`
